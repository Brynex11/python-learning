...
# Here, '''Takes in a number n, returns the square of n''' is a docstring
...
# as their doc attribute. We can later use this attribute to retrieve
# this docstring.
...
# to write Python code. It was written in 2001 by Guido van Rossum, Barry
# Warsaw, and Nick Coghlan. The primary focus of PEP 8 is to improve the
...
# Python and documents aspects of Python, like design and style, for
...
# Run this in your terminal to see it yourself:
import this